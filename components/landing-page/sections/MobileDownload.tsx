...
const MobileDownload = () => {
  return (
    <div className="bg-[#E3EDFD] pt-[120px] pb-[50px]  lg:w-[86%] mx-auto rounded-3xl">
        <div className="grid grid-cols-1 lg:flex">
            <div className="mx-8 md:mx-20">
                <h1 className="text-2xl lg:text-5xl font-medium ">Get Centra On-The-Go!</h1>
                ...
                <div className="md:flex md:gap-5 pt-5">
                    <button className="bg-primary w-full md:w-auto  text-white px-5 py-4 flex items-center rounded-lg mb-4">
            ...
            <div className="w-full">
                <Image src="/img/mobile.png" alt="mobile" width={250} height={200} className="hidden lg:block mb-[-50px] mx-auto"/>
            </div>
        </div>
    </div>
  )
